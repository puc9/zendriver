...
class TouchPoint:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TouchPoint:
        return cls(
            x=float(json['x']),
            y=float(json['y']),
            radius_x=None if json.get('radiusX') is None else float(json['radiusX']),
            radius_y=None if json.get('radiusY') is None else float(json['radiusY']),
            rotation_angle=None if json.get('rotationAngle') is None else float(json['rotationAngle']),
            force=None if json.get('force') is None else float(json['force']),
            tangential_pressure=None if json.get('tangentialPressure') is None else float(json['tangentialPressure']),
            tilt_x=None if json.get('tiltX') is None else float(json['tiltX']),
            tilt_y=None if json.get('tiltY') is None else float(json['tiltY']),
            twist=None if json.get('twist') is None else int(json['twist']),
            id_=None if json.get('id') is None else float(json['id']),
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> TouchPoint | None:
        if json is None:
            return None
...
class GestureSourceType(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> GestureSourceType | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class MouseButton(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> MouseButton | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class DragDataItem:
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> DragDataItem | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class DragData:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DragData:
        return cls(
            items=[DragDataItem.from_json(i) for i in json.get('items', [])],
            drag_operations_mask=int(json['dragOperationsMask']),
            files=[str(i) for i in json.get('files', [])],
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> DragData | None:
        if json is None:
            return None
        return cls.from_json(json)
...
def cancel_dragging() -> Generator[T_JSON_DICT, T_JSON_DICT]:
    """
...
@event_type('Input.dragIntercepted')
@dataclass
class DragIntercepted:
    ...
    **EXPERIMENTAL**
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> DragIntercepted | None:
        if json is None:
            return None
        return cls.from_json(json)
