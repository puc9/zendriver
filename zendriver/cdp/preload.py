...
class RuleSetId(str):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> RuleSetId | None:
        if json is None:
            return None
        return cls.from_json(json)

    def __repr__(self) -> str:
        return f'RuleSetId({super().__repr__()})'
...
class RuleSet:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RuleSet:
        return cls(
            ...
            error_type=RuleSetErrorType.from_json_optional(json.get('errorType')),
            error_message=None if json.get('errorMessage') is None else str(json['errorMessage']),
            tag=None if json.get('tag') is None else str(json['tag']),
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> RuleSet | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class RuleSetErrorType(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> RuleSetErrorType | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class SpeculationAction(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> SpeculationAction | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class SpeculationTargetHint(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> SpeculationTargetHint | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PreloadingAttemptKey:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PreloadingAttemptKey:
        return cls(
            ...
            url=str(json['url']),
            target_hint=SpeculationTargetHint.from_json_optional(json.get('targetHint')),
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PreloadingAttemptKey | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PreloadingAttemptSource:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PreloadingAttemptSource:
        return cls(
            ...
            rule_set_ids=[RuleSetId.from_json(i) for i in json.get('ruleSetIds', [])],
            node_ids=[dom.BackendNodeId.from_json(i) for i in json.get('nodeIds', [])],
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PreloadingAttemptSource | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PreloadPipelineId(str):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> PreloadPipelineId | None:
        if json is None:
            return None
        return cls.from_json(json)

    def __repr__(self) -> str:
        return f'PreloadPipelineId({super().__repr__()})'
...
class PrerenderFinalStatus(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> PrerenderFinalStatus | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PreloadingStatus(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> PreloadingStatus | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PrefetchStatus(enum.Enum):
    ...
    @classmethod
    def from_json_optional(cls, json: str | None) -> PrefetchStatus | None:
        if json is None:
            return None
        return cls.from_json(json)
...
class PrerenderMismatchedHeaders:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PrerenderMismatchedHeaders:
        return cls(
            ...
            initial_value=None if json.get('initialValue') is None else str(json['initialValue']),
            activation_value=None if json.get('activationValue') is None else str(json['activationValue']),
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PrerenderMismatchedHeaders | None:
        if json is None:
            return None
        return cls.from_json(json)
...
@event_type('Preload.ruleSetUpdated')
@dataclass
class RuleSetUpdated:
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> RuleSetUpdated | None:
        if json is None:
            return None
        return cls.from_json(json)


@event_type('Preload.ruleSetRemoved')
@dataclass
class RuleSetRemoved:
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> RuleSetRemoved | None:
        if json is None:
            return None
        return cls.from_json(json)


@event_type('Preload.preloadEnabledStateUpdated')
@dataclass
class PreloadEnabledStateUpdated:
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PreloadEnabledStateUpdated | None:
        if json is None:
            return None
        return cls.from_json(json)


@event_type('Preload.prefetchStatusUpdated')
@dataclass
class PrefetchStatusUpdated:
    ...
    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PrefetchStatusUpdated | None:
        if json is None:
            return None
        return cls.from_json(json)


@event_type('Preload.prerenderStatusUpdated')
@dataclass
class PrerenderStatusUpdated:
    ...
    mismatched_headers: list[PrerenderMismatchedHeaders]
    ...
    def from_json(cls, json: T_JSON_DICT) -> PrerenderStatusUpdated:
        return cls(
            ...
            pipeline_id=PreloadPipelineId.from_json(json['pipelineId']),
            status=PreloadingStatus.from_json(json['status']),
            prerender_status=PrerenderFinalStatus.from_json_optional(json.get('prerenderStatus')),
            disallowed_mojo_interface=None
            if json.get('disallowedMojoInterface') is None
            else str(json['disallowedMojoInterface']),
            mismatched_headers=[PrerenderMismatchedHeaders.from_json(i) for i in json.get('mismatchedHeaders', [])],
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PrerenderStatusUpdated | None:
        if json is None:
            return None
        return cls.from_json(json)


@event_type('Preload.preloadingAttemptSourcesUpdated')
@dataclass
    ...
    def from_json(cls, json: T_JSON_DICT) -> PreloadingAttemptSourcesUpdated:
        return cls(
            ...
            preloading_attempt_sources=[
                PreloadingAttemptSource.from_json(i) for i in json.get('preloadingAttemptSources', [])
            ],
        )

    @classmethod
    def from_json_optional(cls, json: T_JSON_DICT | None) -> PreloadingAttemptSourcesUpdated | None:
        if json is None:
            return None
        return cls.from_json(json)
